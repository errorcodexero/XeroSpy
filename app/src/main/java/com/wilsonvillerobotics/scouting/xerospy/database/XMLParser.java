...
import com.wilsonvillerobotics.scouting.xerospy.activities.ManageDBActivity;
    ...
    public ArrayList<HashMap<String, TableColumn>> parseXml(){
        ...
        try {
            ...
            if(tokens.length > 0)
            {
                ...
                }else if(fileName.equalsIgnoreCase(TeamMatchContract.TeamMatchEntry.TABLE_NAME + XML_EXT)){
                    map = makeTeamMatchMap();
                    tc.setValue(ManageDBActivity.TABLE_NAME.TEAMMATCH);
                    map.put(TABLE_NAME_KEY,tc);
                    Log.d(TNTAG, TeamMatchContract.TeamMatchEntry.TABLE_NAME);
                    builderTask.builderPublish("Begun parsing " + TeamMatchContract.TeamMatchEntry.TABLE_NAME);
...
//key value type
    ...
    public HashMap<String, TableColumn> makeTeamMatchMap(){
        ...
        teamMatchMap.put(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_ID, new TableIntegerColumn(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_ID));
        teamMatchMap.put(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_TEAM_ID, new TableIntegerColumn(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_TEAM_ID));
        teamMatchMap.put(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_MATCH_ID, new TableIntegerColumn(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_MATCH_ID));
        teamMatchMap.put(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_ALLIANCE, new TableStringColumn(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_ALLIANCE));
        teamMatchMap.put(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_POSITION, new TableIntegerColumn(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_POSITION));
        teamMatchMap.put(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_SCOUT_NAME, new TableStringColumn(TeamMatchContract.TeamMatchEntry.COLUMN_NAME_SCOUT_NAME));
        return teamMatchMap;
    }
